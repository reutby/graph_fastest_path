...
def find_shortest_path(file_name,src,dest):
    """ calculates the shorter path from src vertex to dest vertex
...
if __name__ == "__main__":
    ...
    print("\n-------------negative tests-----------\n")
    print("test1")
    find_shortest_path("exmple1.csv",'w','a')
    #wrong dest name
    print("test2:")
    find_shortest_path("exmple1.csv",'a','w')

    print("\n-------------positive tests-----------\n")
    #positive tests
    print("test1:")
    find_shortest_path("exmple1.csv",'f','c')
    print("test2:")
    find_shortest_path("exmple1.csv",'e','f')
    print("test3:")
    find_shortest_path("exmple1.csv",'a','d')
    print("test4:")
    find_shortest_path("exmple2.csv",'a','f')
